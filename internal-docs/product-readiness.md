...
| `imagemin-pngquant@10` | 部分   | 全 options、quality floor、alpha/背景合成误差与 APNG no-op 已测；自建 pngquant 3.0.3/libimagequant 已有固定源码摘要、Cargo lock、provenance、8 目标 workflow 和 macOS ARM64 tarball smoke，仍缺其余 7 平台证据与 GPL 法律复核。                                                                                                                                                                                                                                |
| `imagemin-mozjpeg@10`  | 部分   | 全 options、progressive、灰度、metadata 与独立解码误差已测；自建 MozJPEG 4.1.1 已有固定源码摘要、provenance、8 目标 workflow 和 macOS ARM64 tarball smoke，仍缺其余 7 平台实跑证据。                                                                                                                                                                                                                                                                           |
| `imagemin-jpegtran@8`  | 部分   | progressive/arithmetic、像素无损和 metadata strip 已测；与 cjpeg 同次构建的 MozJPEG 4.1.1 jpegtran 已接入 provenance、8 目标 workflow 和 macOS ARM64 tarball smoke，仍缺其余 7 平台实跑证据。                                                                                                                                                                                                                                                                  |
...
| root + 平台 optional packages | 部分   | 8 个 binding、8 个 BSD sidecar 和 8 个 GPL pngquant 包均有精确 optional dependency、文件白名单与版本门禁；当前 macOS ARM64 tarball 已验证，尚缺 8 平台完整 artifact。 |
| 多平台二进制 CI               | 部分   | release workflow 已定义 8 target binding/cwebp/MozJPEG/pngquant 构建、artifact 汇总及 GNU/musl/双架构 smoke；尚未在 release tag 上取得实跑证据。                      |
