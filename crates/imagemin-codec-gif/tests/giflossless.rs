...
#[test]
fn rejects_fuzz_canvas_timeout_before_compositing() {
    let error = optimize_gif(&fuzz_canvas_timeout_fixture(), "{}")
        .expect_err("oversized fuzz canvas must fail");
...
fn fuzz_canvas_timeout_fixture() -> Vec<u8> {
    vec![
        0x47, 0x49, 0x46, 0x38, 0x39, 0x61, 0x20, 0x08, 0x08, 0x49, 0x91, 0x00, 0x00, 0x00, 0x00,
        0x00, 0xFF, 0x28, 0x28, 0x28, 0xDC, 0x50, 0x00, 0x00, 0x00, 0x21, 0xFF, 0x0B, 0x4E, 0x45,
        0x54, 0x53, 0x43, 0x41, 0x50, 0x44, 0x08, 0x00, 0x00, 0x00, 0x2C, 0x00, 0x00, 0x0D, 0x00,
        0x20, 0x00, 0x18, 0x00, 0x00, 0x02, 0x26, 0x84, 0x8F, 0xA9, 0xCB, 0xED, 0x0F, 0xA3, 0x9C,
        0xB4, 0xDA, 0x8B, 0xB3, 0xDE, 0x40, 0xF8, 0xCF, 0x19, 0x1F, 0x18, 0x8E, 0x5E, 0xD8, 0x99,
        0xA8, 0x29, 0xAC, 0x6A, 0xF9, 0x72, 0x2C, 0x4A, 0xD7, 0xF6, 0x8D, 0xE7, 0x7A, 0x58, 0x00,
        0x00, 0x3B,
    ]
}
